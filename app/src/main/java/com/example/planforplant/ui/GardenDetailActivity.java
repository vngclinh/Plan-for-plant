...
public class GardenDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView btnHistory = findViewById(R.id.btnViewDiseaseHistory);
...
// Xoá nhật ký
        ...
        btnHistory.setOnClickListener(v -> {
            Intent Historyintent = new Intent(GardenDetailActivity.this, DiseaseHistoryActivity.class);
            Historyintent.putExtra("gardenId", gardenId); // gửi id để lấy lịch sử bệnh
